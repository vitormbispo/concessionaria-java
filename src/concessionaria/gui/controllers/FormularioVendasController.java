package concessionaria.gui.controllers;

import java.time.LocalDate;
import java.time.format.DateTimeFormatter;
import concessionaria.dados.DadosClientes;
import concessionaria.dados.DadosFuncionarios;
import concessionaria.dados.DadosVeiculos;
import concessionaria.dados.DadosVendas;
...
public class FormularioVendasController {
    ...
    public void modificarVenda(Venda venda,String cliente, String funcionario, String veiculo, String data, String valor) {
        ...
        if(venda.getCliente() == null || !venda.getCliente().getCpf().equals(cliente))
            entradasValidas = entradasValidas & validarCliente(cliente);
        if(venda.getFuncionario() == null || !Long.toString(venda.getFuncionario().getNumeroMatricula()).equals(funcionario))
            entradasValidas = entradasValidas & validarFuncionario(funcionario);
        if(venda.getVeiculo() == null || !venda.getVeiculo().getChassi().equals(veiculo))
