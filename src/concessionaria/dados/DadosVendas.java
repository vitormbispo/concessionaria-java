...
import concessionaria.entidades.Venda;
import concessionaria.entidades.Veiculo;
import concessionaria.entidades.Cliente;
...
public class DadosVendas {
    ...
    /**
     * Remove as referências de um cliente das vendas a ele associadas
     * @param cliente Cliente a remover
     */
    public static void removerRefCliente(Cliente cliente) {
        em.getTransaction().begin();
        
        Query query = em.createQuery("SELECT v FROM Venda v WHERE v.cliente.id = :idCliente");
    ...
    /**
     * Remove as referências de um funcionário das vendas a ele associadas
     * @param funcionario Funcionário a remover
     */
    public static void removerRefFuncionario(Funcionario funcionario) {
        em.getTransaction().begin();
        
        Query query = em.createQuery("SELECT v FROM Venda v WHERE v.funcionario.id = :idFuncionario");
    ...
    /**
     * Remove as referências de um veículo das vendas a ele associadas
     * @param veiculo Veículo a remover
     */
    public static void removerRefVeiculo(Veiculo veiculo) {
        em.getTransaction().begin();
        
        Query query = em.createQuery("SELECT v FROM Venda v WHERE v.veiculo.id = :idVeiculo");
